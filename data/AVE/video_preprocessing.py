...
class CRAMED_dataset(object):
    def __init__(self, path_to_dataset = '/home/xxx/cv/MML/AVE_Dataset', frame_interval=1, frame_kept_per_second=1):
        ...
        videos = '/home/xxx/cv/MML/AVE_Dataset/video_list.txt'
