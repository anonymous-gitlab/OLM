...
class VGGSound(Dataset):
    ...
    def __init__(self, args, mode='train'):
        ...
        with open('/mnt/lustre/xxx/code/OGM-GE/link/dataset_lustre/MML/VGGSound_processed/pkl_list.txt', 'r') as f:
            lines = f.read().splitlines()
        
        pkl_keys = set(lines)
        
        with open('/mnt/lustre/xxx/code/OGM-GE/data/VGGSound/vggsound.csv') as f:
