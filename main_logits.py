...
from engines.engine_logits import train_or_eval_model
...
def main(args, configs):
    ...
    for fold in range(args.num_folder):
        ...
        for epoch in range(args.epochs):
            train_results = train_or_eval_model(args, model, cls_loss, train_loader, optimizer_network, optimizer_logits, weights, iteration, train=True)
            eval_results = train_or_eval_model(args, model, cls_loss, eval_loader)
            iteration += 1
