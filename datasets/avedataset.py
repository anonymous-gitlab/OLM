...
class AVEDataset(Dataset):
    '''
    arxiv: https://arxiv.org/abs/1803.08842
    ...
    def __init__(self, args, mode='train'):
        ...
        self.my_dict = {
                ...
                27: "Flute"}
        if args.dataset == 'AVE':
            self.data_root = '/home/xxx/cv/logit_modulation/data/AVE_proessed/AVE/'
    ...
    def __getitem__(self, idx):
        ...
        # samples, rate = librosa.load(audio_path, sr=16000)
        ...
        #     t[i] = seg * i + 1
        #     image.append(Image.open(visual_path + "/" + select_samples[i]).convert('RGB'))
